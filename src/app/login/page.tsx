      ...
      >
        ...
        >
          <div className="w-full" style={{ maxWidth: '360px', margin: '0 auto' }}>
            ...
            <p className="text-slate-500 mb-6 text-sm" style={{ whiteSpace: 'normal' }}>
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="w-full py-3 bg-[#FF8C69] hover:bg-orange-600 text-white font-bold text-sm rounded-xl shadow-md transition-all mt-4 disabled:opacity-70"
                style={{ width: '100%', display: 'block' }}
              >
            ...
            <p className="text-center text-xs text-slate-500 mt-6" style={{ whiteSpace: 'normal' }}>
              Belum punya akun? <Link className="text-orange-500 font-bold hover:underline" href="/register">Daftar</Link>
            </p>
