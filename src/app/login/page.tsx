      ...
      >
        ...
        >
          <div className="w-full" style={{ maxWidth: '360px', margin: '0 auto' }}>
            ...
            <p className="text-slate-600 mb-6 text-sm" style={{ whiteSpace: 'normal' }}>
              Masuk untuk melanjutkan perjalanan habitmu.
            </p>
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="w-full py-3 text-white font-bold text-sm rounded-xl shadow-[0_8px_20px_rgba(192,132,252,0.3)] transition-all mt-4 disabled:opacity-70 hover:-translate-y-0.5 hover:shadow-[0_12px_25px_rgba(192,132,252,0.4)]"
            ...
            <p className="text-center text-xs text-slate-600 mt-6" style={{ whiteSpace: 'normal' }}>
              Belum punya akun? <Link className="text-violet-600 font-bold hover:underline" href="/register">Daftar</Link>
            </p>
