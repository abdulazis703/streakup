...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF9F2] text-slate-800 font-sans selection:bg-orange-200 selection:text-orange-900 overflow-x-hidden">
      <ForceLightMode />
      <header className="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-xl shadow-[0_4px_20px_rgba(158,66,37,0.05)]">
      ...
      <main className="w-full pt-20 bg-surface min-h-screen">
        <div className="flex flex-col w-full">
          ...
          {/* Feature Grid */}
          <section id="fitur" className="px-container-padding py-xl bg-surface-container-lowest/50">
            <div className="max-w-[1200px] w-full mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-lg">
                {/* Card 1 */}
                <div className="group p-lg rounded-[24px] bg-surface border border-surface-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
                ...
                <div className="group p-lg rounded-[24px] bg-surface border border-surface-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
                  <div className="flex gap-xs mb-lg">
                    <span className="w-8 h-8 rounded-full bg-surface-container-high flex items-center justify-center text-[18px]">✨</span>
                    <span className="w-8 h-8 rounded-full bg-surface-container-high flex items-center justify-center text-[18px]">🌿</span>
                    <span className="w-8 h-8 rounded-full bg-surface-container-high flex items-center justify-center text-[18px]">🌙</span>
                  </div>
          ...
          <section id="tentang" className="px-container-padding py-xl overflow-hidden">
            <div className="max-w-[1200px] w-full mx-auto flex flex-col items-center gap-xl">
              ...
              <div className="w-full relative">
                <div className="absolute inset-0 bg-primary/5 blur-3xl rounded-full scale-110 -z-10"></div>
                <div className="w-full rounded-[32px] overflow-hidden bg-white shadow-[0_40px_100px_rgba(0,0,0,0.08)] border-[12px] border-surface-container-high">
                  {/* Browser Header */}
                  <div className="h-12 bg-surface-container-high flex items-center px-lg gap-sm">
                  ...
                  {/* Mock Content */}
                  <div className="p-lg grid grid-cols-1 md:grid-cols-3 gap-lg bg-surface">
          ...
          <section className="px-container-padding py-xl">
            <div className="max-w-[1000px] w-full mx-auto bg-primary rounded-[40px] p-8 md:p-14 relative overflow-hidden flex flex-col items-center text-center gap-6">
              <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.15)_0%,transparent_70%)] pointer-events-none"></div>
      ...
      <footer className="w-full bg-surface-container-low py-xl">
